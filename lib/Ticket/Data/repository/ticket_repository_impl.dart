...
class TicketRepositoryImpl implements TicketRepository {
  ...
  @override
  Future<Either<Failure, TicketEntity>> updateInfoTicket(TicketEntity ticketEntity) async{
   try {
     final TicketEntity resp = await ticketLocalDataSource.updateInfoTicket(ticketEntity);
     return right(resp);
   } on LocalFailure {
     throw Left(LocalFailure());
   }
